...
const VirtualAssistant = () => {
  ...
  useEffect(() => {
    document.title = "Medical Virtual Assistant Services | Optimum Billing Solutions";
    const meta = document.querySelector('meta[name="description"]');
    if (meta) {
      meta.setAttribute("content", "HIPAA-trained medical virtual assistant services for healthcare practices. Remote front desk support, insurance verification, prior auth, scheduling, and more — at a fraction of in-house staffing costs.");
    }
  }, []);
